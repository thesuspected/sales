        ...
        <div class='card bg-white'>
            <div class='flex flex-col gap-default flex-grow'>
                <div class='flex items-center gap-default text-primary size-30px'>
                    ...
                    прослушивание<br> звонков
                </div>
                <span>
                    Важно не только научиться продавать, но и <b>закрепить приобретенные навыки</b> в долгую.
                    <br><br>
                    На протяжении трёх месяцев мы будем прослушивать звонки и составлять отчеты по каждому сотруднику, а также устраивать <b>еженедельную онлайн встречу</b> с разбором допущенных ошибок.
                    <br><br>
                    Данная стратегия <b class='text-primary'>кратно повышает эффективность</b> менеджеров за счёт контроля и отработки ошибок на реальных клиентах.
                </span>
            </div>
        </div>

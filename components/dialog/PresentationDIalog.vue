    ...
    <q-dialog :model-value="modelValue" @hide="closeDialog" transition-show="jump-up" transition-hide="jump-down">
        <q-card class="dialog-card p-small shadow-lg">
            <q-card-section class="row items-center q-pb-none">
                <div class="text-h6 font-bold text-black unbounded title-text">
            ...
            <q-card-section class="grid grid-cols-1 lg:grid-cols-2 gap-container pt-0 lg:pt-4">
                <img src="/svg/presentation_3.svg" alt="" class="card-illustration lg:order-last h-full" />
                <RequestForm :source="source" @send-request="sendRequest">
                    <div class="pb-small">Хотите узнать больше? Запишитесь, и мы расскажем</div>
                </RequestForm>
            </q-card-section>
        </q-card>
    </q-dialog>
